...
- [x] 기본 3개 출처 YAML 작성
- [x] 필드 누락 오류 테스트
- [x] 초기 `auto_publish_allowed: false` 고정
...
- [x] 4개 테이블 컬럼 확정
- [x] canonical_url UNIQUE 제약
- [x] (outbox.status) 인덱스
- [x] (metrics.kind, recorded_at) 인덱스
...
- [x] verify_schema.py 작성
- [x] rollback run-book 문서화
- [x] 로그 경로·포맷 확정
...
- [x] Alembic 외 DDL 금지 lint
- [x] DROP PR 체크리스트
- [x] deprecation 로그 양식 정의
...
- [x] 1차 출처 3개 YAML 작성
- [ ] 2차 출처 추가 차단 규약
- [x] auto_publish_allowed 일괄 false 검증

## 변경 기록

- 2026-04-20 초안 작성.
- 2026-04-26 구현 현황 체크 갱신. Phase 0 구현 완료 항목을 체크리스트에 반영.
